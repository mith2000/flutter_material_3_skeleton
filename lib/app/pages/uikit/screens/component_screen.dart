      ...
      child: Wrap(
        ...
        children: [
          FloatingActionButton.small(
            heroTag: "floating_action_button_1",
            onPressed: () {},
            tooltip: 'Small',
            child: const Icon(Icons.add),
          ),
          FloatingActionButton.extended(
            heroTag: "floating_action_button_2",
            onPressed: () {},
            tooltip: 'Extended',
            icon: const Icon(Icons.add),
          ...
          FloatingActionButton(
            heroTag: "floating_action_button_3",
            onPressed: () {},
            tooltip: 'Standard',
            child: const Icon(Icons.add),
          ),
          FloatingActionButton.large(
            heroTag: "floating_action_button_4",
            onPressed: () {},
            tooltip: 'Large',
            child: const Icon(Icons.add),
          ),
      ...
      child: Wrap(
        ...
        children: [
          ...
          Card(
            ...
            child: InkWell(
              splashColor: const Color(0xFF1D1B20).withOpacity(0.1),
              onTap: () {},
                    ...
                    child: const SizedBox(
                      ...
                      child: Center(
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Custom Card with Container'),
                            rowDivider,
                            Badge(child: Icon(Icons.fiber_new_rounded)),
                          ],
                        ),
          ...
          SizedBox(
            ...
            child: Scaffold(
              floatingActionButton: FloatingActionButton(
                heroTag: "floating_action_button_5",
                onPressed: () {},
                elevation: 0.0,
                child: const Icon(Icons.add),
              ),
  ...
  Widget build(BuildContext context) {
    return NavigationRail(
      ...
      leading: FloatingActionButton(
        heroTag: "floating_action_button_6",
